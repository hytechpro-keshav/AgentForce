 ...
 * surface renders sanitized Node 1, Node 2, Node 3, and Node 4 execution artifacts; it
    ...
    <main className="mx-auto flex min-h-screen max-w-7xl flex-col gap-4 p-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Live, read-only engineering view of Node 1 triage, Node 2 customer context, Node 3 knowledge guidance, and Node 4 parts logistics.
        </p>
      </div>

...
> **Status:** **LIVE PROOF COMPLETE (2026-06-23).** 6c-Pre SF deployed; 6c-a/RC-1a/6c-b/RC-8a/RC-1b on Railway; smoke `ASSERT_STOP_AI` + `ASSERT_APPROVAL_TIMEOUT` green; **S1–S5 proven** (S4/S5 Case 00001065). Lessons: [`node6-6c-stop-ai-lessons.md`](../context/node6-6c-stop-ai-lessons.md) · Runbook: [`node6-6c-stop-ai-live-proof.md`](../testing/node6-6c-stop-ai-live-proof.md).
